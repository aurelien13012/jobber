...
const MainScreen = () => {
    ...
    if (isTalent) {
        return (
            <View>
                <RecruiterTemplate name={fakeDataCompanies[index].companyName} fonction={fakeDataCompanies[index].poste} description={fakeDataCompanies[index].description} />
                <StandardButton title={"Passer"} onPress={}/>
            </View>
        )
    }
