...
const LoginScreen = () => {
    ...
    const stateSetterRecruiter = [setCompany, setName, setFirstName, setEmail, setPassword];
    ...
    if (route.params?.type === recruiter) {
        return (
            ...
            <View style={styles.input}>
                ...
                <InputView value={[company, email, password]} setter={stateSetterRecruiter} placeHolder={["company", email, password]}/>
            </View>
