...
const LoginScreen = () => {
    ...
    if (route.params?.type === recruiter) {
        return (
            ...
            <View style={styles.input}>
                ...
                <InputView 
                value={[company, email, password]} setter={stateSetterNewRecruiter} placeHolder={["company", "email", "password"]}
    ...
    return (
        ...
        <View style={styles.input}>
            <Text style={styles.errorMsg}>{errorMsg}</Text>
            <InputView 
            value={[name, firstName, email, password]} setter={stateSetterNewTalent} placeHolder={["name", "firstName", "email", "password"]}
    ...
    return (
        ...
        <View style={styles.input}>
            <Text style={styles.errorMsg}>{errorMsg}</Text>
            <InputView 
            value={[email, password]} setter={stateSetterUser} placeHolder={["email", "password"]}
